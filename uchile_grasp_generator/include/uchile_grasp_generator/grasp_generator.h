#ifndef UCHILE_GRASP_GRASP_GENERATOR_H
#define UCHILE_GRASP_GRASP_GENERATOR_H
...
class CylindricalGraspGenerator : public GraspGenerator
{
 ...
 public:
   ...
   * \brief Constructor
   */
  CylindricalGraspGenerator(const ros::NodeHandle &nh, const uchile_grasp_generator::GraspOptions &opt);
...
#endif //UCHILE_GRASP_GRASP_GENERATOR_H
