...
def main():
    ...
    spos=PoseStamped()
    #Position 
    spos.pose.position.x, spos.pose.position.y, spos.pose.position.z = -0.21, -0.25, 0.64

    #simple_orientation = Quaternion(0.0,-0.70710678,0.0,0.70710678)
    #Orientation
    spos.pose.orientation.x, spos.pose.orientation.y, spos.pose.orientation.z, spos.pose.orientation.w = 0.0, -0.7, -0.001, 0.7
    ...
    rospy.loginfo('MOVING: -0.000332274, -0.261155, 0.665898')
    g.moveToPose(spos,"benderl_wrist_pitch_link")

    rospy.sleep(3.0)
    rospy.loginfo('POSITION: (-0.000332274, -0.261155, 0.665898)')
