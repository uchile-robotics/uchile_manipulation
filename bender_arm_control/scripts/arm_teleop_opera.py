...
class SimpleArmTeleop(object):
    ...
    BUTTONS = {
        ...
        'open_gripper': 4, # LB + LEFT
        'close_gripper': 5, # LB + RIGHT
        'wave': 4, # LB + A
        # Video
        'hold_video': 7, # RB
        'forward_video': 0,  # RB + UP
        'backward_video': 2 # RB + DOWN
    }
    ...
    def __init__(self):
        ...
        self.video_list = get_video_files(SimpleArmTeleop.VIDEO_FOLDER)
    ...
    def process_joy_arm(self, msg):
        ...
        # Reset move state
        if not msg.buttons[SimpleArmTeleop.BUTTONS['reset']] == 1:
            self.move_state = 0
