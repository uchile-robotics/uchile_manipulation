...
// Capability map
#include <uchile_workspace_analysis/GetCapabilityMap.h>
...
// Typedef for DB
typedef mongo_ros::MessageCollection<uchile_workspace_analysis::GraspStorage> GraspStorageDb;
...
typedef std::map<std::string, uchile_workspace_analysis::CapabilityMapOptions> CapabilityMapOptionsTable;
typedef std::map<std::string, uchile_grasp_generator::CylindricalGraspGeneratorPtr> GraspGeneratorTable;
typedef std::map<std::string, uchile_grasp_generator::GraspFilterPtr> GraspFilterTable;
...
private:
  ...
  bool getCapabilityMapCb(uchile_workspace_analysis::GetCapabilityMap::Request &req,
